'''
This file is part of the neural-transport package. The file in the original repository can be found at: https://github.com/vitusbenson/neural_transport/blob/main/neural_transport/models/unet.py
Benson V, Bastos A, Reimers C, et al. Atmospheric transport modeling of CO2 with neural networks[J]. Journal of Advances in Modeling Earth Systems, 2025, 17(2): e2024MS004655.
'''
...
@dataclass
class UnetModulusMetaData(modulus.ModelMetaData):
    name: str = "UnetModulus"
    # Optimization
    jit: bool = True
