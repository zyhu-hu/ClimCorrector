...
from sfno_modulus import SFNOModulus
import sfno_modulus as sfno_modulus
...
def main(cfg: DictConfig) -> float:
    ...
    model = SFNOModulus(
        ...
        embed_dim=cfg.sfno.embed_dim,
        num_layers=cfg.sfno.num_layers,
        use_mlp=cfg.sfno.use_mlp,
    ).to(dist.device)
