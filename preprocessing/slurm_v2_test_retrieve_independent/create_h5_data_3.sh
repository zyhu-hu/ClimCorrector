...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2/1990/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2/1991/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2/1992/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2/1993/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2/1994/' \
    --start_idx 0 \
    --stride_sample 1 
