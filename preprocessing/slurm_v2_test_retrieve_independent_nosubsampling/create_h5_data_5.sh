...
python preprocessing/create_h5_data_v2_retrieve_independent_nosubsampling.py \
    ...
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2_include_lastfile/2000/' \
...
python preprocessing/create_h5_data_v2_retrieve_independent_nosubsampling.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2_include_lastfile/2001/' \
...
python preprocessing/create_h5_data_v2_retrieve_independent_nosubsampling.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2_include_lastfile/2002/' \
...
python preprocessing/create_h5_data_v2_retrieve_independent_nosubsampling.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2_include_lastfile/2003/' \
...
python preprocessing/create_h5_data_v2_retrieve_independent_nosubsampling.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_replay_2iter/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v2_iter2_include_lastfile/2004/' \
