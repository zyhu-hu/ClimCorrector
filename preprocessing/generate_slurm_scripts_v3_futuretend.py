...
python preprocessing/preprocess_climcorr_train_data_v3_futuretend.py {year}
"""
    # Path to save SLURM scripts
    slurm_path = "/Users/zeyuanhu/Documents/research/ClimCorrector/preprocessing/slurm_v3_futuretend_preprocessing/"
