...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/2015/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/2016/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/2017/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/2018/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/2019/' \
    --start_idx 0 \
    --stride_sample 1 
