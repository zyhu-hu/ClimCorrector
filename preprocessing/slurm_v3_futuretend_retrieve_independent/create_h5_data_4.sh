...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/1995/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/1996/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/1997/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/1998/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs04/CESM215_out/Run/archive/spcam_2iter1_inst/atm/hist/' \
    --save_path '/n/home00/zeyuanhu/scratch/climcorr_preprocessing/v3_futuretend/1999/' \
    --start_idx 0 \
    --stride_sample 1 
